 ...
 */
define('SECRET_ACCESS_TOKEN', 'dfshlbsfdhtwwgclkjbdlgjsfdjgkedfgdfd');

/**
 * The address of the remote GIT repository that contains the code we're
 * updating
 */
define('REMOTE_REPOSITORY', 'https://github.com/Cylindric/TankWatch.git');
 ...
 */
define('TARGET_DIR', '/var/www/vhosts/cylindric.net/httpdocs/TankWatch');
